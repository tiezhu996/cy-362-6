  ...
  public OverviewResponse getOverview() {
    return new OverviewResponse(
      ...
      List.of(new FeatureItem(1, "剧本库与DM管理", "录入剧本信息（名称、类型、难度、时长、人数、主持人DM要求），上传剧本封面与简介，关联专属DM主持人，支持按标签筛选与搜索。", "已上线", "88%"),
        ...
        new FeatureItem(4, "玩家评价系统", "支持对剧本和DM分别打分写评语，评价结果在剧本库页面展示平均分和历史列表，帮助新客选本参考。", "已上线", "10 条"),
        new FeatureItem(5, "会员积分与等级体系", "注册会员消费积累积分，设置等级规则（如青铜/白银/黄金/钻石），不同等级享受折扣与优先拼车位权益，积分可兑换周边或抵扣费用。", "优化中", "4 级"),
        new FeatureItem(6, "营收与上座率分析", "管理员查看每日/周/月营收报表、各剧本上座率排行、DM带本场次与评分统计，支持导出营业数据。", "可导出", "28 条")),
      List.of(new KpiItem("今日处理", "98", "+12%", "primary"),
        new KpiItem("预约/订单", "31", "+8%", "warm"),
        new KpiItem("剧本评分", "4.6", "⭐ 优秀", "cool"),
        new KpiItem("累计评价", "42", "需跟进", "neutral")),
      List.of(new OperationRecord("ldmurdergame-1", "剧本库与DM管理", "运营组", "已上线", "88%", "高"),
        ...
        new OperationRecord("ldmurdergame-4", "玩家评价系统", "产品组", "已上线", "10 条", "高"),
        new OperationRecord("ldmurdergame-5", "会员积分与等级体系", "财务组", "优化中", "4 级", "高"),
        new OperationRecord("ldmurdergame-6", "营收与上座率分析", "审核组", "可导出", "28 条", "中"))
    );
  }
}
